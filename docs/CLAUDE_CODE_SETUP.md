...
```json
{
  "midnight-mcp": {
    ...
    "args": [
      "/full/path/to/midnight-mcp-old/dist/mcp/stdio-server.js"
    ],
    "env": {
      "AGENT_ID": "workshop",
      "LOG_LEVEL": "error"
    },
    "cwd": "/full/path/to/midnight-mcp-old"
  }
}
```
...
| `cwd` | Project root directory (fixes path resolution) | `/path/to/midnight-mcp-old` |
